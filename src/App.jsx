...
const App = () => {
    ...
    // --- NEW: Calculations for separate cards and lists ---
    ...
    const renderApp = () => (
        <div className="w-full max-w-4xl bg-white rounded-2xl shadow-xl p-6 sm:p-8 text-gray-800">
            <div className="flex justify-between items-center mb-4">
                ...
                <button onClick={handleLogout} disabled={authLoading} className="bg-red-500 hover:bg-red-600 text-white font-bold py-2 px-4 rounded-full text-sm">Sign Out</button>
            </div>
            ...
            {/* --- RE-ADDED: Separate summary cards --- */}
            ...
            <div className="flex justify-center gap-4 mb-8">
                <button onClick={() => { setModalType('income'); setIsModalOpen(true); }} className="bg-green-500 hover:bg-green-600 text-white font-bold py-2 px-4 rounded-lg">Add Income</button>
                <button onClick={() => { setModalType('expense'); setIsModalOpen(true); }} className="bg-red-500 hover:bg-red-600 text-white font-bold py-2 px-4 rounded-lg">Add Expense</button>
                <button onClick={handleExportCSV} className="bg-gray-500 hover:bg-gray-600 text-white font-bold py-2 px-4 rounded-lg">Download CSV</button>
            </div>
            
            {/* --- RE-ADDED: Two-column layout for transactions --- */}
